...
#define STRING_VERSION_CONFIG_H __DATE__ "2015-04-24 13:38" __TIME__ // build date and time
...
// #define CUSTOM_MACHINE_NAME "TMIT 3D"
...
#define DEFAULT_RETRACT_ACCELERATION  60   // E acceleration in mm/s^2 for retracts
